...
posts = pd.read_xml(r'../../data/bioinformatic/Posts.xml')
...
seman_tags = pd.read_csv(r'../../data/bioinformatic/w2v_CBOW.csv')
tg_names = seman_tags.columns.values.tolist()

tag_obs_len1 = pd.read_csv(r'../../data/bioinformatic/bioinformatic_tags_observation_len1.csv')    
tag_obs_len2 = pd.read_csv(r'../../data/bioinformatic/bioinformatic_tags_observation_len2.csv')
tag_obs_len3 = pd.read_csv(r'../../data/bioinformatic/bioinformatic_tags_observation_len3.csv')
tag_obs_len4 = pd.read_csv(r'../../data/bioinformatic/bioinformatic_tags_observation_len4.csv')
tag_obs_len5 = pd.read_csv(r'../../data/bioinformatic/bioinformatic_tags_observation_len5.csv')
...
#################### Apiori Alg.
tags = []
with open('../../data/bioinformatic/bioinformatic_permutation_tags.csv', newline='') as csvfile:
...
for qu in idis:
    ...
    if len(sim_qu) > 0:
        ...
        subscription = []
        if ll == 0:
            with open('../../data/bioinformatic/bioinformatic_sem_sim_questions.csv', 'a', newline='') as f_object:  
