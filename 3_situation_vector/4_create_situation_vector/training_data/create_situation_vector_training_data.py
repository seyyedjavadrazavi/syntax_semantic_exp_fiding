...
train_data = pd.read_csv(r"../../../data/bioinformatics/bioinformatics_train_data.csv")
...
train_data = train_data.dropna(subset = ['OwnerUserId'])

comb_list = list()
for ques in train_data.iterrows():
    ques = ques[1]
    print(ques['Id'])
...
res.to_csv('../../../data/bioinformatics/bioinformatics_train_data_combination.csv', index=False)